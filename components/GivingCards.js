    ...
    <div className="grid sm:grid-cols-2 gap-4">
      {GIVING.map((g) => (
        <Tag
          key={g.id}
          href={href}
          className="group giving-card bg-white border border-[#ddd5c4] rounded-sm p-5 hover:border-[#c9a84c] hover:shadow-[0_8px_24px_rgba(30,45,78,0.08)] transition-all"
        >
