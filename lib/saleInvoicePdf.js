...
export function buildSaleInvoicePdf({ data, buyer }) {
  ...
  if (buyer.id) doc.text(`Reference: ${buyer.id}`, M, y, { width: W, align: 'right' })
  y += 28
  ...
  doc.text(
    balance <= 0
      ? 'Thank you for your support of the Shteibel.'
      : 'Please remit the balance due at your earliest convenience. Questions? Reply to this message or contact the gabbai.',
    M,
    y,
    { width: W, lineGap: 3 },
  )
